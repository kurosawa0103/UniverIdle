...
namespace Fungus
{
    ...
    public static class MenuSignals
    {
        ...
        /// <summary>
        /// MenuOptionSelected signal. Sent when the player clicks a menu option.
        /// </summary>
        public static event MenuOptionSelectedHandler OnMenuOptionSelected;
        public delegate void MenuOptionSelectedHandler(string optionText);
        public static void DoMenuOptionSelected(string optionText)
        {
            if (OnMenuOptionSelected != null)
            {
                OnMenuOptionSelected(optionText);
            }
        }
        #endregion
    }
