...
public class SteamManager : MonoBehaviour {
	...
	public static bool Initialized {
		get {
			...
			return s_instance != null
				&& s_instance.m_bInitialized
				&& CallbackDispatcher.IsInitialized;
		}
	}
	...
	protected virtual void OnDestroy() {
		...
		// 先清标志，避免 Shutdown 后同帧 Update 仍调用 RunCallbacks
	...
	protected virtual void Update() {
		...
		// Domain Reload / 退出 Play 时 dispatcher 可能已重置，而 m_bInitialized 仍为 true
